...
struct VolumeGuardApp: App {
    ...
    var body: some Scene {
        ...
        Window("VolumeGuard", id: "dashboard") {
...
struct QuickPanel: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("VolumeGuard").font(.title2.bold())
...
struct Dashboard: View {
    ...
    private var header: some View {
        HStack {
            ...
            VStack(alignment: .leading) {
                Text("VolumeGuard").font(.largeTitle.bold())
                ...
                ForEach(monitor.visibleVolumes) { volume in
                    GroupBox {
                        VStack(alignment: .leading, spacing: 10) {
                            ...
                            Text(monitor.forecast(volume)).font(.caption).foregroundStyle(.secondary)
    ...
    private var settings: some View {
        GroupBox("Preferences") {
            VStack(alignment: .leading, spacing: 12) {
                Toggle("Show internal macOS volumes", isOn: $monitor.showSystemVolumes)
